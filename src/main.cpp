...
// toggles the theme from the View menu.
void applyAppTheme(bool light) {
    ...
    if (light) {
        c[ImGuiCol_Text] = ImVec4(0.08f, 0.08f, 0.08f, 1.f);
        c[ImGuiCol_TextDisabled] = ImVec4(0.45f, 0.45f, 0.45f, 1.f);
        c[ImGuiCol_WindowBg] = ImVec4(0.95f, 0.95f, 0.95f, 1.f);
        c[ImGuiCol_ChildBg] = ImVec4(0.90f, 0.90f, 0.90f, 1.f);
        c[ImGuiCol_PopupBg] = ImVec4(0.94f, 0.94f, 0.94f, 0.98f);
        c[ImGuiCol_Border] = ImVec4(0.55f, 0.55f, 0.55f, 1.f);
        c[ImGuiCol_BorderShadow] = ImVec4(0.f, 0.f, 0.f, 0.f);
        c[ImGuiCol_FrameBg] = ImVec4(0.88f, 0.88f, 0.88f, 1.f);
        c[ImGuiCol_FrameBgHovered] = ImVec4(0.80f, 0.80f, 0.80f, 1.f);
        c[ImGuiCol_FrameBgActive] = ImVec4(0.73f, 0.73f, 0.73f, 1.f);
        c[ImGuiCol_TitleBg] = ImVec4(0.95f, 0.95f, 0.95f, 1.f);
        c[ImGuiCol_TitleBgActive] = ImVec4(0.95f, 0.95f, 0.95f, 1.f);
        c[ImGuiCol_TitleBgCollapsed] = ImVec4(0.95f, 0.95f, 0.95f, 1.f);
        c[ImGuiCol_MenuBarBg] = ImVec4(0.88f, 0.88f, 0.88f, 1.f);
        c[ImGuiCol_ScrollbarBg] = ImVec4(0.95f, 0.95f, 0.95f, 1.f);
        c[ImGuiCol_ScrollbarGrab] = ImVec4(0.72f, 0.72f, 0.72f, 1.f);
        c[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.62f, 0.62f, 0.62f, 1.f);
        ...
        c[ImGuiCol_Button] = ImVec4(0.86f, 0.86f, 0.86f, 1.f);
        c[ImGuiCol_ButtonHovered] = ImVec4(0.79f, 0.79f, 0.79f, 1.f);
        c[ImGuiCol_ButtonActive] = ImVec4(0.73f, 0.73f, 0.73f, 1.f);
        c[ImGuiCol_Header] = ImVec4(0.86f, 0.86f, 0.86f, 1.f);
        c[ImGuiCol_HeaderHovered] = ImVec4(0.79f, 0.79f, 0.79f, 1.f);
        c[ImGuiCol_HeaderActive] = ImVec4(0.73f, 0.73f, 0.73f, 1.f);
        c[ImGuiCol_Separator] = ImVec4(0.70f, 0.70f, 0.70f, 1.f);
        c[ImGuiCol_SeparatorHovered] = ImVec4(0.012f, 0.455f, 0.784f, 1.f);
        c[ImGuiCol_SeparatorActive] = ImVec4(0.118f, 0.565f, 0.882f, 1.f);
        c[ImGuiCol_ResizeGrip] = ImVec4(0.78f, 0.78f, 0.78f, 1.f);
        c[ImGuiCol_ResizeGripHovered] = ImVec4(0.012f, 0.455f, 0.784f, 1.f);
        c[ImGuiCol_ResizeGripActive] = ImVec4(0.118f, 0.565f, 0.882f, 1.f);
        c[ImGuiCol_Tab] = ImVec4(0.95f, 0.95f, 0.95f, 1.f);
        c[ImGuiCol_TabHovered] = ImVec4(0.82f, 0.82f, 0.82f, 1.f);
        c[ImGuiCol_TabActive] = ImVec4(0.88f, 0.88f, 0.88f, 1.f);
        c[ImGuiCol_TabUnfocused] = ImVec4(0.95f, 0.95f, 0.95f, 1.f);
        c[ImGuiCol_TabUnfocusedActive] = ImVec4(0.92f, 0.92f, 0.92f, 1.f);
        c[ImGuiCol_NavHighlight] = ImVec4(0.012f, 0.455f, 0.784f, 1.f);
        c[ImGuiCol_TableHeaderBg] = ImVec4(0.86f, 0.86f, 0.86f, 1.f);
        c[ImGuiCol_TableBorderStrong] = ImVec4(0.62f, 0.62f, 0.62f, 1.f);
        c[ImGuiCol_TableBorderLight] = ImVec4(0.72f, 0.72f, 0.72f, 1.f);
    } else {
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int) {
    ...
    while (running) {
        ...
        float clearColor[4];
        if (g_lightTheme) {
            clearColor[0] = 0.82f; clearColor[1] = 0.82f; clearColor[2] = 0.84f; clearColor[3] = 1.0f;
        } else {
            clearColor[0] = 0.12f; clearColor[1] = 0.12f; clearColor[2] = 0.14f; clearColor[3] = 1.0f;
        }

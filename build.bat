...
cl /nologo /std:c++17 /EHsc /O2 /W3 /utf-8 /DUNICODE /D_UNICODE /Isrc /Ithird_party\imgui /Ithird_party\imgui\backends /Ithird_party\imgui\misc\cpp ^
  ...
  /link app.res user32.lib gdi32.lib shell32.lib ole32.lib advapi32.lib d3d11.lib dxgi.lib d3dcompiler.lib winhttp.lib windowscodecs.lib winmm.lib /SUBSYSTEM:WINDOWS
